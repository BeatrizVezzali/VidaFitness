...
public class MainActivity extends ReactActivity {
    ...
    // Adicione o método onCreate com o @Override
  @Override
  ...
  public Bundle getBundleFromIntent(Intent intent) {
    ...
    if (intent.hasExtra("Minha chave do provedor da noticação")) {
      return intent.getBundleExtra("Minha chave do provedor da notificação");
    }
    return null;
  }
});
